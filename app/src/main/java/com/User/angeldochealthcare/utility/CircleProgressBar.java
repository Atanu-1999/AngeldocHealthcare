    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            TypedArray ta = context.obtainStyledAttributes(attrs,
                    R.styleable.ExtCircleProgressBar);
            mProgressDrawable = ta
                    .getDrawable(R.styleable.ExtCircleProgressBar_extprogressDrawable);
            if (mProgressDrawable != null) {
                setProgressDrawable(mProgressDrawable);
            }

            mIndeterminateDrawable = ta
                    .getDrawable(R.styleable.ExtCircleProgressBar_extindetermiateDrawable);
            ...
            setIndeterminate(ta.getBoolean(
                    R.styleable.ExtCircleProgressBar_extindetermiate, false));
            mNoInvalidate = false;
            ta.recycle();
        }
    }
