...
public class Home_Spec_Adapter extends RecyclerView.Adapter<Home_Spec_Adapter.ViewHolder>{
    public static List<Specialization_Response.Result> SpecList;
    private Context context;
    ListSpecListener listener;

    public Home_Spec_Adapter(Context context, List<Specialization_Response.Result> SpecList, ListSpecListener listener) {
    ...
    @NonNull
    @Override
    public Home_Spec_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.home_spec_layout, parent, false);
        Home_Spec_Adapter.ViewHolder viewHolder = new Home_Spec_Adapter.ViewHolder(view);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull Home_Spec_Adapter.ViewHolder holder, int position) {
