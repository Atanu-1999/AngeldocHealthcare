...
public class Verify_List_Adapter extends RecyclerView.Adapter<Verify_List_Adapter.ViewHolder>{
    public static List<Verifyed_Doc_Response.Result> VerifyList;
    private Context context;
    Verify_Doc_Listner listener;

    public Verify_List_Adapter(Context context,List<Verifyed_Doc_Response.Result> VerifyList, Verify_Doc_Listner listener) {
    ...
    @NonNull
    @Override
    public Verify_List_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.verify_list_layout, parent, false);
        Verify_List_Adapter.ViewHolder viewHolder = new Verify_List_Adapter.ViewHolder(view);
        return viewHolder;
    }
